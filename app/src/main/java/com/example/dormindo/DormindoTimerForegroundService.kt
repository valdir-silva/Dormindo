...
class DormindoTimerForegroundService : Service() {
    companion object {
        const val ACTION_START = "com.example.dormindo.action.START_TIMER"
        const val ACTION_PAUSE = "com.example.dormindo.action.PAUSE_TIMER"
        const val ACTION_RESUME = "com.example.dormindo.action.RESUME_TIMER"
        const val ACTION_CANCEL = "com.example.dormindo.action.CANCEL_TIMER"
        const val ACTION_ADD_MINUTE = "com.example.dormindo.action.ADD_MINUTE"
        ...
        const val ACTION_TIMER_UPDATE = "com.example.dormindo.action.TIMER_UPDATE"
