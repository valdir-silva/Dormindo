...
import net.alunando.dormindo.data.datasource.TimerWorkStatus
    ...
    override suspend fun startTimer(timer: Timer): Result<Timer> {
        return try {
            ...
            if (scheduleResult.isSuccess) {
                ...
                val context = (notificationDataSource as? net.alunando.dormindo.data.datasource.NotificationDataSource)?.let { it.javaClass.getDeclaredField("context").apply { isAccessible = true }.get(it) as? Context }
                context?.let {
